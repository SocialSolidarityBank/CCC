...
| E3-8 동의 6영역 migration | E3-4, SG7 | `migrations/postgres/0004_supabase_platform.sql` 뒤에 consent와 legacy observation을 `migrations/sqlite/0048_consent_six_domains.sql`, `migrations/postgres/0005_consent_six_domains.sql`로 병합한다. 6개 literal과 append-only event, parity, RLS, `ccc_api` role, schema snapshot을 갱신하고 기존 2종을 자동 승격하지 않는다. |
