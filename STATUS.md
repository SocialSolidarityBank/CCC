...
- **Last updated**: 2026-07-28 (에이전트 — 공개 레포 민감 문단 정리: Slack 채널·계정 ID, Linear 연동 UUID, 과거 보안 대응 세부를 CLAUDE.md·ticket-thread-protocol.md·.gitleaks.toml에서 제거, 구체 값은 레포 밖 portwright 노트로 이관.)
