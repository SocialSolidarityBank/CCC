...
/* D58 계열 의미 고정(CCC-54): 민트=진행·상태, 블루=정보·일정. */
.status.mint{border-color:var(--mint-deep);background:var(--mint-tint)}
.status.blue{border-color:var(--blue-deep);background:var(--blue-tint)}
