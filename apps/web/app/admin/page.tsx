...
// 관리자 영역 기관 화면(재개편 T8, #38 · Figma 5:350). 내부 전용 단일 기관이므로 목록은 1행
// 자리만 둔다(멀티테넌트 확장 여지, D1·D27). 기관 상세는 이후 티켓 소관.
  ...
  return (
    <>
      ...
      <div className="wire-admin-list">
        {orgId === null ? (
          <p className="wire-admin-empty" role="alert">기관 정보를 확인할 수 없습니다.</p>
        ) : (
