...
export const CONSENT_DETAIL_SECTIONS: ConsentDetailSection[] = [
  ...
  },
  {
    ...
    items: [
      '[선택] AI를 활용한 녹취기록 동의: 상담 내용을 녹음해 음성-텍스트 전환(전사)과 감정 추이 분석에 이용하고, 상담 기록(수기 메모·전사)을 AI가 요약·정리합니다. 음성 원본은 업로드 후 30일 이내 자동 삭제됩니다. AI 처리 전에 성명·연락처와 구체적인 질병명 등을 가명·마스킹 처리한 뒤 외부 AI 서비스에 위탁 처리하며, 자동화 기술의 특성상 드물게 일부 정보가 완전히 제거되지 않을 수 있는 잔여 위험이 있습니다. 이를 최소화하기 위한 2단계 보호 조치를 적용합니다.',
    ],
  },
  {
    heading: '6. 동의 거부 권리',
