...
export const CONSENT_DETAIL_SECTIONS: ConsentDetailSection[] = [
  ...
  },
  {
    heading: '6. 동의 거부 권리',
    paragraphs: [
      '각 항목의 동의를 거부할 수 있으며, 거부하더라도 상담 서비스 이용에 불이익이 없습니다. 다만 AI를 활용한 녹취기록에 동의하지 않으면 녹음·전사·감정 추이 분석(현재 제공하지 않음, D64 보류)과 AI 요약·정리가 모두 제공되지 않습니다. 실무자가 직접 작성하는 상담 기록은 그대로 유지됩니다.',
    ],
  },
];
